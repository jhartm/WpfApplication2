...
namespace WpfApplication2
{
    ...
    /// </summary>
    public class AsynchronousCommand3 : Command, INotifyPropertyChanged
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AsynchronousCommand3"/> class.
        /// </summary>
        /// <param name="action">The action.</param>
        /// <param name="canExecute">if set to <c>true</c> the command can execute.</param>
        public AsynchronousCommand3(Action action, bool canExecute = true)
        ...
        public AsynchronousCommand3(Action<object> parameterizedAction, bool canExecute = true)
